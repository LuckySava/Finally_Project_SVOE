...
var switchText = document.getElementById("switch_text"),
    input = document.getElementById("switch"),
    block1 = document.getElementById("block_1");

var arrowBlocks = document.getElementsByClassName("arrows");

var _loop = function _loop(arrowBlock) {
	var arrowLeft = arrowBlock.querySelector(".arrows_left"),
...
try {
	for (var _iterator = arrowBlocks[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
		var arrowBlock = _step.value;
...
//# sourceMappingURL=/js.7d121c70.map